   ...
   stage('deploy') {
                 steps{
                   ...
                   sh '''
                                ...
                                ssh -i ~/.ssh/id_rsa_ec2 ec2-user@172.31.3.86 "cd /home/ec2-user/REA_Deployment/artifacts/SinatraApp/ && docker build -t SinatraAPPImage-1.0 && docker run -d -p 80:9292 --name SinatraAPPContainer SinatraAPPImage-1.0"
                                '''
                   }
                 }
        }
